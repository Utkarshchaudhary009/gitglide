...
2.  **Harmonious Typography Scale**
    ...
    *   *Example:* 16px (Base), 20px (h6), 25px (h5), 31.25px (h4)...
...
3.  **Accessible Color Palette (60-30-10 Rule)**
    ...
    *   *Critical:* Always check contrast ratios (aim for WCAG AA standard or 4.5:1).
...
9.  **Clear & Helpful Error Handling**
    ...
    *   Provide a helpful message explaining *how* to fix it (e.g., "Password must contain at least one number").
